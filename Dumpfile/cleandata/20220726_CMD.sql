...
) ENGINE=InnoDB AUTO_INCREMENT=496 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `proposal_type_details` (
  ...
  `placeholder` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `proposal_type_details` VALUES (1,1,'1','Mục đích/Lý do',1,'-1','-1','2022-03-28','2022-03-28',1,'\"\'','Nhập mục đích/lý do tạo đề xuất..','Vui lòng nhập mục đích/lý do tạo đề xuất.'),(2,1,'2','Tình trạng hư hỏng',2,'-1','-1','2022-03-28','2022-03-28',1,'Các bạn điền rõ tình trạng hư hỏng của thiết bị để nhóm sửa chữa chuẩn bị sẳn dụng cụ để sửa chữa nhé!','Nhập tình trạng hư hỏng...','Vui lòng nhập tình trạng như hỏng.'),(3,1,'3','Số phòng',1,'-1','-1','2022-03-28','2022-03-28',1,'\"\"','Nhập số phòng...','Vui lòng nhập số phòng.'),(4,1,'4','Ghi chú',2,'-1','-1','2022-03-28','2022-03-28',0,'Các bạn mô tả vị trí của thiết bị hư hỏng trong phòng giúp mình nhé!','Nhập ghi chú...','Vui lòng nhập ghi chú.'),(5,2,'1','Mục đích/Lý do',1,'-1','-1','2022-03-28','2022-03-28',1,NULL,'Nhập mục đích/lý do tạo đề xuất..','Vui lòng nhập mục đích/lý do tạo đề xuất.'),(6,2,'2','Tên vật tư',1,'-1','-1','2022-03-28','2022-03-28',1,NULL,'Nhập tên vật tư','Vui lòng nhập tên vật tư.'),(7,2,'3','Số lượng',1,'-1','-1','2022-03-28','2022-03-28',1,NULL,'Nhập số lượng','Vui lòng nhập số lượng.'),(8,2,'4','Đơn gía',1,'-1','-1','2022-03-28','2022-03-28',1,NULL,'Nhập đơn giá','Vui lòng nhập đơn giá.');
...
-- Dump completed on 2022-07-26 22:23:11
