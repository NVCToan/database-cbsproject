...
INSERT INTO `approval_step_details` VALUES (1,'1',1,NULL,3,16),(2,'2',1,NULL,1,7),(4,'3',1,NULL,4,13);
...
INSERT INTO `roles` VALUES (1,'1','Điều hành các hoạt động của KTX'),(2,'2','Duyệt các đề xuất nghỉ phép của sinh viên'),(3,'3','Giải quyết các vấn đề tiền ăn và học phí'),(4,'4','Quản lý cơ sở vật chất, an ninh KTX'),(5,'5','Sinh viên'),(6,'6','Nhận đề xuất và thực hiện sửa chữa hư hỏng cho các phòng'),(7,'7','Quản lý, chấm điểm rèn luyện cho SV và điểm danh SV');
...
-- Dump completed on 2022-03-26 23:35:52
