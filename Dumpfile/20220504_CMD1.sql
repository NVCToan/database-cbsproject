...
CREATE TABLE `mytable` (
  ...
  `description` varchar(154) COLLATE utf8_unicode_ci NOT NULL,
  `create_date` varchar(19) COLLATE utf8_unicode_ci NOT NULL,
  `receiver_id` int(11) NOT NULL,
  `finish_date` varchar(19) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-05-04 14:56:25
