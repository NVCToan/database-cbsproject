...
CREATE TABLE `employees` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=353 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `messages` VALUES (1,'E','DEPE1','Phòng ban đang được sử dụng'),(2,'E','EMPE1','Không được khóa tài khoản trưởng phòng'),(3,'E','DEPE2','Mã phòng ban này đã tồn tại'),(4,'E','POSE1','Thêm chức vụ vào phòng ban thất bại!'),(5,'E','EMPE2','Không thể xóa nhân viên là trưởng phòng'),(6,'S','EMPS1','Thêm danh sách nhân viên thành công'),(7,'E','EMPE3','Có lỗi xảy ra khi thêm danh sách nhân viên'),(8,'E','EMPE4','Có lỗi xảy ra khi thêm nhân viên'),(9,'S','EMPS2','Thêm nhân viên thành công');
...
) ENGINE=InnoDB AUTO_INCREMENT=382 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `teams_employees` VALUES (55,1,104),(56,1,352);
...
-- Dump completed on 2022-05-01 21:39:53
